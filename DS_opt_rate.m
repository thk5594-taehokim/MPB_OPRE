function DS_opt_rate(obj, type, flag_VFA)
...
[vom, ~] = BalMat(obj.mpb_vec, obj.mpb_sol, x_b, type);
...
if flag_VFA
    N_1 = obj.N; N_2 = obj.N;
    N_1(idx_1(1), idx_1(2)) = N_1(idx_1(1), idx_1(2)) + 1; rho_1 = compute_VFA(obj.Y, var_S, N_1); tot_max_1 = min(min(vom.*rho_1));
    N_2(idx_2(1), idx_2(2)) = N_2(idx_2(1), idx_2(2)) + 1; rho_2 = compute_VFA(obj.Y, var_S, N_2); tot_max_2 = min(min(vom.*rho_2));
    if tot_max_1 < tot_max_2
        idx = idx_2;
    else
        idx = idx_1;
    end
